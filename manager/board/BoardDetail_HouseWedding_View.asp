					...
					<div class="col-lg-12">
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form id="frm_boardins" name="frm_boardins" method="post" action="BoardDetail_HouseWedding_Proc.asp" ENCTYPE="multipart/form-data">
								...
								<%if YN_CNTVIEW = "Y" then %>
									<tr>
										...
										<td>
											<div class="col-lg-3">
												<input class="form-control" type="text" id="NO_CNTVIEW" name="NO_CNTVIEW" value="<%=NO_VIEWCNT%>" maxlength="5" />
											</div>
										</td>
									</tr>
								<%else %>
								...
								%>
									...
									<%if ary_FIELDTYPE(iloop) = "TEXT" then %>
										...
										<td>
											...
											<div class="col-lg-8">
												<span class="text-info">*<%=ary_FIELDINFO(iloop)%></span>
											</div>
										</td>
								...
								<%end if %>
									...
									<p class="text-center">
										...
										<button type="button" class="btn" onclick="document.location.href='BoardDetail_HouseWedding.asp?CD_BOARDCD=<%=CD_BOARDCD%>'"> <i class="fa fa-list"></i> 목록</button>
									</p>
								</form>
							</div>
						</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		{
			toolbar: 'Full',
			skin: 'office2013', //에디터 스킨 (kama, office2003, v2)
			uiColor: '#14B8C4',
