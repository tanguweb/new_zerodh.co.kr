...
'	if Result1 = "SUCCESS" and instr(Result2,"ERROR") = 0 then 
	if Result1 = "SUCCESS" then 
		If MODE = "I" Then	' 등록
			Rtn_string = "<script>alert('게시글이 저장되었습니다.');document.location.href='BoardDetail_HouseWedding.asp?CD_BOARDCD="&CD_BOARDCD&"';</script>" 
		ElseIf MODE = "U" Then	' 수정
			Rtn_string = "<script>alert('게시글이 수정되었습니다.');document.location.href='BoardDetail_HouseWedding.asp?CD_BOARDCD="&CD_BOARDCD&"';</script>" 
		ElseIf MODE = "D" Then	' 삭제
			Rtn_string = "<script>alert('게시글이 삭제되었습니다.');document.location.href='BoardDetail_HouseWedding.asp?CD_BOARDCD="&CD_BOARDCD&"';</script>" 
		End If 
