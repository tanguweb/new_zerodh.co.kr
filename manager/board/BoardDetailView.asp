				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="ibox float-e-margins">
							...
							<%if bCustomForm then %>
									<input type="hidden" id="NM_CONTENTS" name="NM_CONTENTS" value="<%=NM_CONTENTS%>">
								<%else %>                  
									<tr>
										...
										<td>
											<div class="col-lg-4">
												<div class="input-group date">
													<input class="form-control field_type_date" type="text" id="NM_FIELD_<%=iloop%>" name="NM_FIELD_<%=iloop%>" value="<%=ary_FIELD(iloop)%>" data-mask="99999999" />
