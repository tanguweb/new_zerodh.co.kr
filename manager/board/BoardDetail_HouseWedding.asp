...
End If
		...
		SQL = SQL & "	(																										"
		SQL = SQL & "		SELECT																								"
		SQL = SQL & "		ROW_NUMBER() OVER (ORDER BY BD.NM_FIELD_2 ASC) AS [No]	"
		...
		'							20				21				'22			'23			'24
		SQL = SQL & "		, BD.NO_DOWNLOAD, BD.CD_BOARDKEY, BD.NM_FIELD_15, BD.NM_FIELD_2							"
		'							20				21				'22				'23
		SQL = SQL & "		FROM																								"
		SQL = SQL & "			T_BOARDMAST AS BM																				"
		SQL = SQL & "				INNER JOIN T_BOARDDETAIL AS BD																"
...
<body>	
			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="javascript:void(0)">하우스웨딩</a>
                        </li>
                        <li class="active">
							...
							<div class="ibox-content">
								...
								<div class="table-responsive">
									...
									<table class="table table-hover">
										...
										%>
											<tr>
												<td class="text-center"><%=aryBoardList(1,iloop)%></td>
												<td class="text-left">
										...
										<tfoot>
											<tr>
												<td class="text-center" colspan="<%=spancnt%>">
													<%
														Call PageNavigation("/manager/board/BoardDetail_HouseWedding.asp","CD_BOARDCD="&CD_BOARDCD&"&sGUBUN="&sGUBUN&"&sKEYWORD="&sKEYWORD&"&sDISPLAY="&sDISPLAY&"&sSTARTDATE="&sSTARTDATE&"&sENDDATE="&sENDDATE, tn, pgcount, startpage, page, setsize, prevpage, nextpage)
													%>
												</td>
											</tr>
										</tfoot>
	...
	<script type="text/javascript">
		...
		function fn_Search()
		{
			...
			document.location.href = "BoardDetail_HouseWedding.asp?CD_BOARDCD=<%=CD_BOARDCD%>&sGUBUN="+sgubun+"&sKEYWORD="+skeyword+"&sDISPLAY="+sDisplay+"&sSTARTDATE="+sStartdate+"&sENDDATE="+sEnddate;
		}

		function fn_boardview(CD_BOARDID)
		{
			document.location.href="BoardDetail_HouseWedding_View.asp?page=<%=page%>&CD_BOARDID="+CD_BOARDID;
		}

		function fn_BoardIns(CD_BOARDCD,CD_BOARDID,CD_BOARDKEY,NO_BOARD_DEPTH,NO_BOARD_SEQ)
		{
			document.location.href="BoardDetail_HouseWedding_Ins.asp?CD_BOARDCD="+CD_BOARDCD+"&CD_BOARDID="+CD_BOARDID+"&CD_BOARDKEY="+CD_BOARDKEY+"&NO_BOARD_DEPTH="+NO_BOARD_DEPTH+"&NO_BOARD_SEQ="+NO_BOARD_SEQ;
		}
