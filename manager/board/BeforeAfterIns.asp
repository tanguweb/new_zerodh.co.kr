					...
					<div class="col-lg-12">
						...
						<div class="ibox">
							...
							<div class="ibox-content">
								<form id="frm_boardins" name="frm_boardins" method="post" action="BeforeAfter_Proc.asp" ENCTYPE="multipart/form-data">
								...
								%>
									...
									<tr>
										...
										<td>
											<div class="col-lg-12">
												<div class="text-success m-b-md">
													권장 이미지 사이즈: 550px * 380px
												</div>
											<table class="table table-bordered table-hover">
												...
												<tbody id="before_after_image">
													<tr>
														...
														<td>
															<input type="file" class="before_after_image" data-index="0" name="BEFORE_IMG_0" value="" />
															<input type="hidden" name="hd_BEFORE_IMG_0" value="" />
														</td>
														<td>
															<input type="file" name="AFTER_IMG_0" value="" />
															<input type="hidden" name="hd_AFTER_IMG_0" value="" />
														</td>
													</tr>
												</thead>
											</table>											
