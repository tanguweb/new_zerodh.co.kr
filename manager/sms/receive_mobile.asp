...
<%
	'########################################################################################
	'#	File		: /manager/sms/receive_mobile.asp
	'#  Create		: 
	'#	Info		: SMS 수신 번호 관리
	'#	Update		: 
	'#	Update Memo	: 
	...
	SQL = SQL & "	T_CODE													"
	SQL = SQL & "WHERE													"
	SQL = SQL & "	CD_GUBUN = 'COUNSEL_SMS_RECEIVER'		"
...
<body class="skin-2">
					...
					<div class="col-lg-12">
						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5><i class="fa fa-user"></i> 상담 SMS 수신자 관리 <small>상담글 등록시 SMS 알림을 수신할 휴대전화번호를 관리합니다.</small></h5>
							</div>
										...
										<table class="table table-striped table-hover">
											<thead>
												<tr>
													...
													<th class="text-center">휴대전화번호</th>
											...
											<tbody>
												<tr>
													...
													<td class="text-center"><input type="text" class="form-control" id="NM_CODE3" name="NM_CODE3" autocomplete="off" placeholder="전화번호 구분자 (-) 를 입력해주세요." /></td>
													<td class="text-center">
	...
	<script type="text/javascript">
		function fn_submit()
		{
			...
			document.frm_UserList.action = "receive_mobile_proc.asp";
		...
		function fn_userList(Mode,ID)
		{
			...
			{	
				...
				if (ValPhone_V3(NM_CODE3.value, '', true) == false)
				{
					alert("유효하지 않은 휴대전화번호 형식 입니다.");
					NM_CODE3.focus();
					return false;
				}
			...
			else if (Mode == "U")
			{
				...
				if (ValPhone_V3(update_NM_CODE3.value, '', true) == false)
				{
					alert("유효하지 않은 휴대전화번호 형식 입니다.");
					update_NM_CODE3.focus();
					return false;
