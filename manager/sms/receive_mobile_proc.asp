...
<%	
	...
	If MODE = "I" Then 
		...
		SQL = SQL & "	VALUES ('COUNSEL_SMS_RECEIVER','"&CD_CODE&"','"&NM_CODE&"','"&NM_CODE1&"','"&NM_CODE2&"','"&NM_CODE3&"','','','','',100,'"&YN_USE&"')"
		objADO.setSQL(SQL)
		objADO.ExecuteQuery()
	...
	ElseIf MODE = "U" Then 
		...
		SQL = SQL & "	WHERE CD_GUBUN = 'COUNSEL_SMS_RECEIVER' AND CD_CODE = '"&CD_CODE&"' "
		objADO.setSQL(SQL)
		objADO.ExecuteQuery()
		Set objADO = Nothing
