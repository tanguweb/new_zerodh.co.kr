...
<%
	...
	Dim NM_FIELD_1  : NM_FIELD_1 = getText(ReqF("counselUserName_landing"))
	Dim NM_FIELD_2  : NM_FIELD_2 = getText(ReqF("counselMobile_landing"))
	Dim NM_FIELD_4  : NM_FIELD_4 = "9998"	'"랜딩 상담"	'getText(UploadForm("counselType"))
	...
	Dim NM_TITLE	: NM_TITLE = (Left(Trim(NM_FIELD_1), Len(Trim(NM_FIELD_1)) - 1) & "*") & "님이 랜딩 상담을 남기셨습니다."
	...
	Dim HTTP_REFERER : HTTP_REFERER = ReqF("HTTP_REFERER_landing")
	Dim HTTP_USER_AGENT : HTTP_USER_AGENT = ReqF("HTTP_USER_AGENT_landing")
	Dim HTTP_DEVICE_TYPE : HTTP_DEVICE_TYPE = ReqF("HTTP_DEVICE_TYPE_landing")
	Dim HTTP_MEDIA_TYPE : HTTP_MEDIA_TYPE = ReqF("HTTP_MEDIA_TYPE_landing")
	...
	If NM_FIELD_1 = "" Or NM_FIELD_2 = "" Then
	...
	If Result1 = "SUCCESS" Then
		...
		If isSendMail = True Then
			...
			If sTo <> "" Then
				...
				objMail.Subject = "["&m_client_counsel_regist_email_title&"] 랜딩 상담 신청이 접수되었습니다." & " (신청자: " & NM_FIELD_1 & ")"
		...
		If isSendSMS = True Then
			...
			If IsArray(aryRecvSMSList) Then
				For sms_i = 0 To UBound(aryRecvSMSList, 2)
					'jsonResult("sms_result") = sendSMS_cafe24("["&m_client_counsel_regist_sms_title&"] 신규 랜딩상담이 등록되었습니다.(신청자:"&NM_FIELD_1&"/"&Replace(NM_FIELD_2, "-" ,"")&")", aryRecvSMSList(5, sms_i), "")
					jsonResult("sms_result") = sendSMS_cafe24("["&m_client_counsel_regist_sms_title&"] 신규 랜딩상담이 등록되었습니다("&NM_FIELD_1&"/"&Replace(NM_FIELD_2, "-" ,"")&")", aryRecvSMSList(5, sms_i), "")
				Next
			End If
		End If
