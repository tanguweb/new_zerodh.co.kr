...
<%
	...
	Dim NM_FIELD_1  : NM_FIELD_1 = getText(ReqF("mainCounselUserName_quick"))
	Dim NM_FIELD_2  : NM_FIELD_2 = getText(ReqF("mainCounselPhone_quick"))
	...
	Dim NM_CONTENTS : NM_CONTENTS = Replace(getText(ReqF("mainCounselContent_quick")) ,Chr(13)&Chr(10),"<br />")
	Dim HTTP_REFERER : HTTP_REFERER = ReqF("HTTP_REFERER_side")
	Dim HTTP_USER_AGENT : HTTP_USER_AGENT = ReqF("HTTP_USER_AGENT_side")
	Dim HTTP_DEVICE_TYPE : HTTP_DEVICE_TYPE = ReqF("HTTP_DEVICE_TYPE_side")
	Dim HTTP_MEDIA_TYPE : HTTP_MEDIA_TYPE = ReqF("HTTP_MEDIA_TYPE_side")
	...
	If Result1 = "SUCCESS" Then 
		...
		Dim isSendMail : isSendMail = m_client_counsel_quick_send_email	'메일 발송할 것인지 여부
		...
		Dim isSendSMS : isSendSMS = m_client_counsel_quick_send_sms	'SMS 발송할 것인지 여부
