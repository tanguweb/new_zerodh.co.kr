	...
	If Result1 = "SUCCESS" Then
		...
		If MODE = "I" Then
			...
			If isSendSMS = True Then
				...
				End If
			End If
			Response.Write "<script type='text/javascript' src='//wcs.naver.net/wcslog.js'></script><script type='text/javascript'>if (!wcs_add) var wcs_add={};wcs_add['wa'] = 's_2f72707af981';if (!_nasa) var _nasa={};_nasa['cnv'] = wcs.cnv('4','1');wcs_do(_nasa);</script>"
